...
public class UserController {
    ...
    public ResponseEntity<?> startFollowing(@RequestBody FollowRequest request) {
        ...
        String message =
                String.format(
                        "%s 가 %s를 팔로잉 했습니다", request.fromUser().nickname(), request.toUser().nickname());
